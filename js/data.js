...
const I18N = {
  en: {
    ...
    tool_flow_t: "The Product Journey",
    tool_flow_d: "Watch an order travel from the ad to the doorstep",
  ...
  ar: {
    ...
    tool_flow_t: "رحلة المنتج",
    tool_flow_d: "شوف كيف يتحرك الطلب من الإعلان حتى باب الزبون",
