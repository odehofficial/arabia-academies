...
const I18N = {
  en: {
    ...
    hero_sub: "E-commerce, dropshipping and AI — taught in Arabic by Mohammad Odeh, in e-commerce since 2012. Join 3,500+ students building real online businesses.",
    ...
    mentor_p1: "It started in 2012, selling men's bracelets on Facebook in Jordan — before Instagram even had ads. Since then: five brands, tens of millions spent on ads, and selling worldwide from Saudi Arabia, Jordan, the UAE and now Germany.",
    mentor_p2: "The teaching began during COVID, helping family and friends earn online — for free. Word spread, and those lessons became the Arabia academies. Today, alongside his brother Asim Odeh and web expert Sakher Hatamleh, no meeting ends until every question is answered.",
  ...
  ar: {
    ...
    hero_sub: "التجارة الإلكترونية والدروبشيبينغ والذكاء الاصطناعي — بالعربية، مع محمد عودة، في التجارة الإلكترونية منذ 2012. انضم إلى أكثر من ٣٥٠٠ طالب يبنون مشاريع حقيقية.",
    ...
    mentor_p1: "بدأت الحكاية عام 2012 ببيع أساور رجالية على فيسبوك في الأردن — قبل أن توجد إعلانات على إنستغرام أصلاً. منذ ذلك الحين: خمس علامات تجارية، عشرات الملايين على الإعلانات، وبيع لكل العالم من السعودية والأردن والإمارات وحالياً ألمانيا.",
    mentor_p2: "بدأ التعليم في فترة كورونا بمساعدة أهله وأصدقائه على تحقيق دخل من الإنترنت — مجاناً. انتشر الخبر، وتحوّلت تلك الدروس إلى أكاديميات أرابيا. واليوم، مع أخيه عاصم عودة وخبير المواقع صخر حتاملة، لا ينتهي أي لقاء قبل الإجابة عن كل الأسئلة.",
