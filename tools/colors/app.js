...
const PALS = [
  ...
  { cat:"warm", img:"midnight-in-paris", n:"Midnight in Paris (2011)", a:"ميدنايت إن باريس", c:["#D9A441","#8A5A2B","#3E4A6B","#F2DCA8","#5C3A2B"],
    m:{ar:"باريس الليلية بدفء المصابيح القديمة", en:"Paris at night, warmed by old lamplight"} },
  { cat:"warm", img:"little-women", n:"Little Women (2019)", a:"ليتل ويمن", c:["#D9B48A","#8A9A6B","#B85C3F","#F2E4C9","#4A5C7A"],
    m:{ar:"ذكريات عائلية بضوء الشموع والصوف", en:"Family memories in candlelight and wool"} },
  { cat:"warm", img:"benjamin-button", n:"The Curious Case of Benjamin Button (2008)", a:"ذا كيوريوس كيس أوف بنجامين باتن", c:["#C8A05A","#7A5C3A","#3E2E22","#D9C8A8","#5C4A6B"],
    m:{ar:"زمن يمشي بالعكس بلون السيبيا الدافئ", en:"Time in reverse, washed in warm sepia"} },
  { cat:"warm", img:"cinema-paradiso", n:"Cinema Paradiso (1988)", a:"سينما باراديسو", c:["#D98E32","#8A5A2B","#F2DCA8","#5C4A3A","#2E2417"],
    m:{ar:"حنين صالة السينما القديمة", en:"The nostalgia of an old movie theater"} },
  { cat:"warm", img:"slumdog-millionaire", n:"Slumdog Millionaire (2008)", a:"سلامدوغ ميليونير", c:["#E87E2B","#C84B2A","#F2C845","#3E7A8A","#6B2E5C"],
    m:{ar:"مومباي المشتعلة بالبرتقالي والحياة", en:"Mumbai ablaze in orange and life"} },
  { cat:"warm", img:"banshees-of-inisherin", n:"The Banshees of Inisherin (2022)", a:"ذا بانشيز أوف إنشيرين", c:["#C8873F","#5C7A6B","#8A9AA8","#3E3A2E","#E8D8B8"],
    m:{ar:"جزيرة أيرلندية بدفء حزين", en:"An Irish island in sorrowful warmth"} },

  /* ---- Cool & Blue (11) ---- */
  { cat:"cool", img:"the-revenant", n:"The Revenant (2015)", a:"ذا ريفينانت", c:["#5C7A8A","#A8BCC8","#2E3E45","#D9E4E8","#4A3A2E"],
    m:{ar:"برد البرّية القاسي بضوء طبيعي فقط", en:"Brutal wilderness cold in natural light only"} },
  { cat:"cool", img:"arrival", n:"Arrival (2016)", a:"أرايفل", c:["#4A5C6B","#8A9AA8","#2E3438","#C8D2D9","#5C4A3A"],
    m:{ar:"ضباب رمادي أزرق ولقاء مع المجهول", en:"Blue-grey fog and a meeting with the unknown"} },
  { cat:"cool", img:"gone-girl", n:"Gone Girl (2014)", a:"غون غيرل", c:["#3E4A55","#7A8A96","#C8B48A","#1E2428","#96A8B4"],
    m:{ar:"برود مريب تحت سطح مثالي", en:"Suspicious chill under a perfect surface"} },
  { cat:"cool", img:"the-social-network", n:"The Social Network (2010)", a:"ذا سوشال نتوورك", c:["#3E4A45","#6B7A6B","#C8A05A","#1E2422","#8A96A8"],
    m:{ar:"غرف هارفارد الداكنة وطموح بارد", en:"Dark Harvard rooms and cold ambition"} },
  { cat:"cool", img:"prisoners", n:"Prisoners (2013)", a:"بريزنرز", c:["#4A5560","#2E3438","#8A9AA8","#5C4A3A","#C8D2D9"],
    m:{ar:"مطر رمادي لا يتوقف وقلق دائم", en:"Endless grey rain and constant dread"} },
  { cat:"cool", img:"inception", n:"Inception (2010)", a:"إنسيبشن", c:["#3E5C7A","#8AA8C8","#2E3438","#C8873F","#96A8B4"],
    m:{ar:"أحلام فولاذية زرقاء داخل أحلام", en:"Steel-blue dreams within dreams"} },
  { cat:"cool", img:"interstellar", n:"Interstellar (2014)", a:"إنترستيلر", c:["#4A5C6B","#8A9AA8","#D9C8A8","#1E2428","#5C7A8A"],
    m:{ar:"غبار الأرض وبرد الفضاء اللانهائي", en:"Earth's dust and the cold of infinite space"} },
  { cat:"cool", img:"the-dark-knight", n:"The Dark Knight (2008)", a:"ذا دارك نايت", c:["#3E4A55","#1E2428","#8A96A8","#5C6B7A","#C8D2D9"],
    m:{ar:"غوثام فولاذية بأزرق ليلي صارم", en:"Steel Gotham in stern midnight blue"} },
  { cat:"cool", img:"girl-with-the-dragon-tattoo", n:"The Girl with the Dragon Tattoo (2011)", a:"ذا غيرل ويذ ذا دراغون تاتو", c:["#3E4A45","#96A8B4","#2E3438","#C8D2D9","#5C4A3A"],
    m:{ar:"شتاء سويدي قاسٍ بلا دفء", en:"A harsh Swedish winter with no warmth"} },
  { cat:"cool", img:"eternal-sunshine", n:"Eternal Sunshine of the Spotless Mind (2004)", a:"إيترنال صنشاين أوف ذا سبوتلس مايند", c:["#6B8AA8","#C8D2D9","#E8734A","#3E4A55","#A8C0B4"],
    m:{ar:"ذكريات تذوب بأزرق شاحب", en:"Memories dissolving in pale blue"} },
  { cat:"cool", img:"skyfall", n:"Skyfall (2012)", a:"سكايفول", c:["#2E3E55","#6B8AA8","#C8A05A","#1E2428","#8AA8C8"],
  ...
  { cat:"neon", img:"drive", n:"Drive (2011)", a:"درايف", c:["#E85C8A","#2E1E38","#4AC8D9","#F2C845","#1E2428"],
    m:{ar:"ليل لوس أنجلوس بوردي كهربائي", en:"L.A. nights in electric pink"} },
  { cat:"neon", img:"john-wick", n:"John Wick (2014)", a:"جون ويك", c:["#3E2E5C","#E85C8A","#4A8AC8","#1E2428","#C84B5C"],
    m:{ar:"نوادٍ بنفسجية وأناقة قاتلة", en:"Violet clubs and lethal elegance"} },
  { cat:"neon", img:"tron-legacy", n:"Tron: Legacy (2010)", a:"ترون: ليغاسي", c:["#4AC8D9","#1E2428","#E8732B","#2E3E55","#C8D2D9"],
    m:{ar:"شبكة رقمية بسيان متوهج", en:"A digital grid in glowing cyan"} },
  { cat:"neon", img:"la-la-land", n:"La La Land (2016)", a:"لا لا لاند", c:["#3E4A8A","#E85C8A","#F2C845","#6B3A8A","#4AC8D9"],
    m:{ar:"غسق الأحلام بين البنفسجي والذهب", en:"Dream dusk between violet and gold"} },
  { cat:"neon", img:"spider-verse", n:"Spider-Man: Into the Spider-Verse (2018)", a:"سبايدرمان: إنتو ذا سبايدرفيرس", c:["#E8354A","#2E3EC8","#F2C845","#E85C8A","#1E2428"],
    m:{ar:"كوميكس حي بألوان صارخة", en:"A living comic book in loud color"} },
  { cat:"neon", img:"guardians-of-the-galaxy", n:"Guardians of the Galaxy (2014)", a:"غارديانز أوف ذا غالاكسي", c:["#6B3A8A","#E8732B","#4AC8D9","#E85C8A","#2E2E45"],
    m:{ar:"فضاء ملوّن بروح الثمانينات", en:"A colorful cosmos with an '80s soul"} },
  { cat:"neon", img:"atomic-blonde", n:"Atomic Blonde (2017)", a:"أتوميك بلوند", c:["#4AC8D9","#E85C8A","#1E2428","#8A96A8","#F2C845"],
    m:{ar:"برلين الحرب الباردة بنيون بارد", en:"Cold War Berlin in cold neon"} },
  { cat:"neon", img:"nightcrawler", n:"Nightcrawler (2014)", a:"نايتكرولر", c:["#1E2428","#E8732B","#4A5C8A","#C8D2D9","#8A3A2B"],
    m:{ar:"لوس أنجلوس الليلية بعيون جائعة", en:"Nighttime L.A. through hungry eyes"} },
  { cat:"neon", img:"suspiria", n:"Suspiria (1977)", a:"سوسبيريا", c:["#C8354A","#2E1E38","#4A8AC8","#E8B4C8","#1E2428"],
    m:{ar:"كابوس أحمر بجرأة السبعينات", en:"A red nightmare with '70s daring"} },

  /* ---- Pastel & Dreamy (11) ---- */
  { cat:"pastel", img:"grand-budapest-hotel", n:"The Grand Budapest Hotel (2014)", a:"ذا غراند بودابست هوتيل", c:["#E8A8B8","#B85C6B","#F2DCA8","#8AA8C8","#5C3A45"],
    m:{ar:"حلويات معمارية وردية بتناظر مثالي", en:"Pink architectural pastry in perfect symmetry"} },
  { cat:"pastel", img:"moonrise-kingdom", n:"Moonrise Kingdom (2012)", a:"مونرايز كينغدوم", c:["#E8D8A8","#C8873F","#8A9A6B","#D9B48A","#5C6B4F"],
    m:{ar:"صيف كشفي قديم بأصفر باهت", en:"An old scouting summer in faded yellow"} },
  { cat:"pastel", img:"the-french-dispatch", n:"The French Dispatch (2021)", a:"ذا فرينش ديسباتش", c:["#E8C8A8","#8AA8C8","#C85C4A","#F2E4C9","#5C5C6B"],
    m:{ar:"صحافة باريسية بلمسة أنيقة باهتة", en:"Parisian journalism in faded elegance"} },
  { cat:"pastel", img:"darjeeling-limited", n:"The Darjeeling Limited (2007)", a:"ذا دارجيلينغ ليمتد", c:["#4AA8C8","#E8B84A","#C8735C","#F2DCA8","#8A5A6B"],
    m:{ar:"رحلة هندية بألوان التوابل الفاتحة", en:"An Indian journey in light spice colors"} },
  { cat:"pastel", img:"barbie", n:"Barbie (2023)", a:"باربي", c:["#E86BA8","#F2B8D2","#4AC8D9","#F2E45C","#C84B8A"],
    m:{ar:"عالم وردي كامل بلا اعتذار", en:"A fully pink world, unapologetically"} },
  { cat:"pastel", img:"marie-antoinette", n:"Marie Antoinette (2006)", a:"ماري أنطوانيت", c:["#F2C8D2","#A8D2E8","#E8E4C9","#C88A9A","#8AA88A"],
    m:{ar:"مكارون فرساي وترف ناعم", en:"Versailles macarons and soft luxury"} },
  { cat:"pastel", img:"the-truman-show", n:"The Truman Show (1998)", a:"ذا ترومان شو", c:["#8AC8D9","#F2E4C9","#E8A85C","#A8C08A","#4A6B8A"],
    m:{ar:"مدينة مثالية أكثر من اللازم", en:"A town just a little too perfect"} },
  { cat:"pastel", img:"edward-scissorhands", n:"Edward Scissorhands (1990)", a:"إدوارد سيزرهاندز", c:["#A8D2C8","#E8A8B8","#F2E48A","#8A96C8","#3E3A45"],
    m:{ar:"ضواحٍ ملونة تخفي حكاية قوطية", en:"Candy suburbs hiding a gothic tale"} },
  { cat:"pastel", img:"asteroid-city", n:"Asteroid City (2023)", a:"أستيرويد سيتي", c:["#8AC8D9","#E8B84A","#D9B48A","#F2E4C9","#C8735C"],
    m:{ar:"صحراء باستيلية بسماء تركواز", en:"A pastel desert under turquoise sky"} },
  { cat:"pastel", img:"chocolat", n:"Chocolat (2000)", a:"شوكولا", c:["#C88A5C","#8A5A45","#E8C8A8","#A85C6B","#5C4A3A"],
    m:{ar:"كاكاو دافئ وقرية فرنسية محافظة", en:"Warm cocoa in a buttoned-up French village"} },
  { cat:"pastel", img:"wonka", n:"Wonka (2023)", a:"ونكا", c:["#8A5AA8","#E8B84A","#C84B5C","#4AA8C8","#F2DCA8"],
    m:{ar:"حلم حلواني بألوان سحرية", en:"A confectioner's dream in magical color"} },

  /* ---- Desert & Earthy (11) ---- */
  { cat:"desert", img:"dune-part-two", n:"Dune: Part Two (2024)", a:"ديون: بارت تو", c:["#B87A35","#D9A85C","#3E3438","#E8C89A","#6B4A2B"],
    m:{ar:"أراكيس أعمق وأقسى وأجمل", en:"Arrakis — deeper, harsher, more beautiful"} },
  { cat:"desert", img:"mad-max-fury-road", n:"Mad Max: Fury Road (2015)", a:"ماد ماكس: فيوري رود", c:["#E8732B","#C84B2A","#4AA8C8","#8A5A2B","#F2C879"],
    m:{ar:"برتقالي محروق ضد أزرق ليلي — المطاردة الأشهر", en:"Burnt orange vs teal night — the ultimate chase"} },
  { cat:"desert", img:"lawrence-of-arabia", n:"Lawrence of Arabia (1962)", a:"لورنس أوف أرابيا", c:["#D9A85C","#E8C89A","#B87A35","#4A6B8A","#8A5A2B"],
    m:{ar:"الصحراء العربية بأعظم اتساع سينمائي", en:"The Arabian desert at its most cinematic"} },
  { cat:"desert", img:"no-country-for-old-men", n:"No Country for Old Men (2007)", a:"نو كانتري فور أولد مين", c:["#C8A05A","#8A7A5C","#5C4A3A","#D9C8A8","#2E2822"],
    m:{ar:"تكساس الجافة وصمت الخطر", en:"Dry Texas and the silence of danger"} },
  { cat:"desert", img:"sicario", n:"Sicario (2015)", a:"سيكاريو", c:["#C8873F","#5C5C55","#2E3438","#D9B48A","#8A4B2A"],
    m:{ar:"حدود قاسية بغبار وظل", en:"A brutal border in dust and shadow"} },
  { cat:"desert", img:"the-martian", n:"The Martian (2015)", a:"ذا مارشان", c:["#C85C2B","#E8955C","#8A3A22","#D9B48A","#3E3438"],
    m:{ar:"صدأ المريخ ووحدة البقاء", en:"Martian rust and the loneliness of survival"} },
  { cat:"desert", img:"there-will-be-blood", n:"There Will Be Blood (2007)", a:"ذير ويل بي بلد", c:["#8A5A2B","#5C4A3A","#C8A05A","#2E2417","#D9C8A8"],
    m:{ar:"نفط وتراب وطموح أسود", en:"Oil, dirt, and black ambition"} },
  { cat:"desert", img:"the-english-patient", n:"The English Patient (1996)", a:"ذي إنغليش بيشنت", c:["#D9B48A","#C8873F","#8A6B4A","#E8DCC9","#4A5C6B"],
    m:{ar:"كثبان ناعمة وحب في زمن الحرب", en:"Soft dunes and wartime love"} },
  { cat:"desert", img:"raiders-of-the-lost-ark", n:"Raiders of the Lost Ark (1981)", a:"رايدرز أوف ذا لوست آرك", c:["#C8873F","#8A5A2B","#5C4A3A","#D9A85C","#2E2822"],
    m:{ar:"مغامرة كلاسيكية بغبار ذهبي", en:"Classic adventure in golden dust"} },
  { cat:"desert", img:"the-mummy", n:"The Mummy (1999)", a:"ذا مامي", c:["#D9A85C","#B87A35","#8A5A2B","#F2DCA8","#3E3A2E"],
    m:{ar:"مصر الغامضة بذهب المغامرات", en:"Mysterious Egypt in adventure gold"} },

  /* ---- Dark & Moody (11) ---- */
  { cat:"dark", img:"the-batman", n:"The Batman (2022)", a:"ذا باتمان", c:["#1E1E22","#C8354A","#8A6B3F","#3E3438","#5C5C6B"],
    m:{ar:"غوثام ممطرة بأحمر غاضب", en:"Rain-soaked Gotham in furious red"} },
  { cat:"dark", img:"joker", n:"Joker (2019)", a:"جوكر", c:["#3E7A45","#C84B5C","#E8B84A","#2E2E38","#8A5A6B"],
  ...
  { cat:"dark", img:"the-godfather", n:"The Godfather (1972)", a:"ذا غودفاذر", c:["#2E2417","#C8873F","#8A5A2B","#1E1E1E","#D9B48A"],
    m:{ar:"عتمة المكاتب وذهب العائلة", en:"Office darkness and family gold"} },
  { cat:"dark", img:"fight-club", n:"Fight Club (1999)", a:"فايت كلوب", c:["#3E4A45","#8A7A5C","#C8735C","#1E2422","#5C6B5C"],
    m:{ar:"أخضر صناعي قذر وفوضى", en:"Dirty industrial green and chaos"} },
  { cat:"dark", img:"silence-of-the-lambs", n:"The Silence of the Lambs (1991)", a:"ذا سايلنس أوف ذا لامبز", c:["#3E4A45","#8A9A8A","#5C4A3A","#1E2422","#C8D2C8"],
  ...
  { cat:"dark", img:"black-swan", n:"Black Swan (2010)", a:"بلاك سوان", c:["#1E1E22","#E8E4E8","#C84B5C","#8A96A8","#3E3438"],
    m:{ar:"أبيض وأسود يتصارعان بوردية جريحة", en:"White and black at war, with a wounded pink"} },
  { cat:"dark", img:"oldboy", n:"Oldboy (2003)", a:"أولد بوي", c:["#5C2E45","#C8735C","#3E3438","#8A5A2B","#1E2428"],
    m:{ar:"انتقام كوري بنبيذي كابوسي", en:"Korean revenge in nightmarish wine tones"} },
  { cat:"dark", img:"sweeney-todd", n:"Sweeney Todd (2007)", a:"سويني تود", c:["#2E3438","#C8354A","#8A96A8","#1E1E22","#5C5C6B"],
  ...
  { cat:"green", img:"the-shape-of-water", n:"The Shape of Water (2017)", a:"ذا شيب أوف ووتر", c:["#2E5C55","#4A8A7A","#C8873F","#1E3438","#8AC8B4"],
    m:{ar:"حكاية خرافية تحت ماء أخضر", en:"A fairy tale under green water"} },
  { cat:"green", img:"avatar", n:"Avatar (2009)", a:"أفاتار", c:["#2E7A55","#4AC8D9","#8A3AC8","#1E3428","#8AE8B4"],
    m:{ar:"غابة مضيئة من عالم آخر", en:"A glowing forest from another world"} },
  { cat:"green", img:"lord-of-the-rings", n:"The Lord of the Rings (2001)", a:"ذا لورد أوف ذا رينغز", c:["#5C7A45","#8A9A6B","#C8A05A","#2E3A28","#D9C8A8"],
    m:{ar:"خضرة الشاير ودفء البيوت الصغيرة", en:"Shire green and the warmth of small homes"} },
  { cat:"green", img:"pans-labyrinth", n:"Pan's Labyrinth (2006)", a:"بانز لابيرينث", c:["#3E5C45","#8A9A6B","#C8873F","#2E3438","#5C4A6B"],
  ...
  { cat:"green", img:"midsommar", n:"Midsommar (2019)", a:"ميدسومار", c:["#E8E4C9","#A8C08A","#F2D2A8","#C87E8A","#5C7A45"],
    m:{ar:"رعب مشمس وسط الزهور", en:"Sunlit horror among the flowers"} },
  { cat:"green", img:"crouching-tiger", n:"Crouching Tiger, Hidden Dragon (2000)", a:"كراوتشينغ تايغر، هيدن دراغون", c:["#8AA86B","#C8D9A8","#5C7A5C","#D9C8A8","#3E4A38"],
    m:{ar:"غابة الخيزران ورشاقة الحرير", en:"Bamboo forest and silken grace"} },
  { cat:"green", img:"walter-mitty", n:"The Secret Life of Walter Mitty (2013)", a:"ذا سيكرت لايف أوف والتر ميتي", c:["#4A8A7A","#8AC8C8","#C8873F","#5C6B4F","#D9E4E8"],
    m:{ar:"مغامرة آيسلندية بفيروزي منعش", en:"An Icelandic adventure in fresh teal"} },
  { cat:"green", img:"the-northman", n:"The Northman (2022)", a:"ذا نورثمان", c:["#3E4A38","#8A9A8A","#5C4A3A","#1E2422","#C8D2C8"],
    m:{ar:"شمال بارد بأخضر رمادي وحشي", en:"A cold north in savage grey-green"} },

  /* ---- Classic & Retro (11) ---- */
  { cat:"retro", img:"casablanca", n:"Casablanca (1942)", a:"كازابلانكا", c:["#2E2822","#8A7A5C","#C8B48A","#5C5245","#E8DCC9"],
    m:{ar:"أبيض وأسود بدفء الحنين", en:"Black and white with nostalgic warmth"} },
  { cat:"retro", img:"sin-city", n:"Sin City (2005)", a:"سين سيتي", c:["#1E1E1E","#E8E4E8","#C8354A","#5C5C5C","#F2C845"],
    m:{ar:"كوميكس نوار بلمسات لون صادمة", en:"Noir comics with shocking color accents"} },
  { cat:"retro", img:"roma", n:"Roma (2018)", a:"روما", c:["#3E3E3E","#8A8A8A","#C8C8C8","#E8E4E8","#1E1E1E"],
    m:{ar:"ذاكرة مكسيكية بأبيض وأسود حديث", en:"Mexican memory in modern monochrome"} },
  { cat:"retro", img:"pulp-fiction", n:"Pulp Fiction (1994)", a:"بالب فيكشن", c:["#2E2822","#C8354A","#E8B84A","#5C4A3A","#8A9A8A"],
