...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
const PALS = [
  { cat:"series", img:"game-of-thrones", tt:{c:"got",h:"<span>GAME OF</span>THRONES"}, n:"Game of Thrones (2011)", a:"غيم أوف ثرونز", c:["#3E4A55","#A8B4C0","#C8A05A","#8A2E2E","#1E2228"],
  ...
  { cat:"dark", img:"the-godfather", tt:{c:"gf",h:"<span>THE</span>GODFATHER"}, n:"The Godfather (1972)", a:"ذا غودفاذر", c:["#2E2417","#C8873F","#8A5A2B","#1E1E1E","#D9B48A"],
  ...
  { cat:"cool", img:"inception", tt:{c:"inc",h:"INCEPTION"}, n:"Inception (2010)", a:"إنسيبشن", c:["#3E5C7A","#8AA8C8","#2E3438","#C8873F","#96A8B4"],
  ...
  { cat:"green", img:"the-matrix", tt:{c:"mtx",h:"THE MATRIX"}, n:"The Matrix (1999)", a:"ذا ماتريكس", c:["#3E7A45","#1E2E22","#8AC88A","#2E3438","#C8D9C8"],
  ...
  { cat:"retro", img:"pulp-fiction", tt:{c:"pf",h:"PULP FICTION"}, n:"Pulp Fiction (1994)", a:"بالب فيكشن", c:["#2E2822","#C8354A","#E8B84A","#5C4A3A","#8A9A8A"],
  ...
  { cat:"green", img:"lord-of-the-rings", tt:{c:"lotr",h:"<span>THE LORD OF</span>THE RINGS"}, n:"The Lord of the Rings (2001)", a:"ذا لورد أوف ذا رينغز", c:["#5C7A45","#8A9A6B","#C8A05A","#2E3A28","#D9C8A8"],
  ...
  { cat:"green", img:"jurassic-park", tt:{c:"jp",h:"JURASSIC PARK"}, n:"Jurassic Park (1993)", a:"جوراسيك بارك", c:["#3E7A45","#8A9A5C","#C8B48A","#2E3A28","#E8DCA8"],
  ...
  { cat:"retro", img:"michael", tt:{c:"mj",h:"Michael"}, n:"Michael (2026)", a:"مايكل", c:["#0F0F14","#C8354A","#E8C84A","#8A8AB4","#F2F2F2"],
